...
public class BattingAnalyser {
    ...
    public String getBattingAvgAndMaxHundredsWiseSortedData(Path path) throws LeagueException, CSVException{
    	try(Reader reader = Files.newBufferedReader(path)){
    		List<LeagueBatting> battingList = csvBuilder.getCSVFileList(reader, LeagueBatting.class);
    		if(battingList == null || battingList.size() == 0) {
    			throw new LeagueException("No data present", LeagueException.ExceptionType.NO_LEAGUE_DATA);
    		}
    		Comparator<LeagueBatting> battingComparator = Comparator.comparing(batting -> batting.average + batting.century);
    		this.sortDesc(battingList, battingComparator);
    		String sortedBattingData = new Gson().toJson(battingList);
    		return sortedBattingData;
    	}
    ...
    public String getBattingAvgWiseMaxRunsSortedData(Path path) throws LeagueException, CSVException{
    	try(Reader reader = Files.newBufferedReader(path)){
    		List<LeagueBatting> battingList = csvBuilder.getCSVFileList(reader, LeagueBatting.class);
    		if(battingList == null || battingList.size() == 0) {
    			throw new LeagueException("No data present", LeagueException.ExceptionType.NO_LEAGUE_DATA);
    		...
    		Comparator<LeagueBatting> battingComparator = Comparator.comparing(batting -> batting.average);
    		Comparator<LeagueBatting> battingComp = battingComparator.thenComparing(batting -> batting.runs);
    ...
    public String getStrikeRateWiseBattingAverageSortedData(Path path) throws LeagueException, CSVException{
    	try(Reader reader = Files.newBufferedReader(path)){
    		List<LeagueBatting> battingList = csvBuilder.getCSVFileList(reader, LeagueBatting.class);
    		if(battingList == null || battingList.size() == 0) {
    			throw new LeagueException("No data present", LeagueException.ExceptionType.NO_LEAGUE_DATA);
    		...
    		Comparator<LeagueBatting> battingComp = battingComparator.thenComparing(batting -> batting.average);
    		this.sortDesc(battingList, battingComp);
    		String sortedBattingData = new Gson().toJson(battingList);
    		return sortedBattingData;
    	}
    ...
    public String getZeroHundredsAndFiftiesWiseSortedData(Path path) throws LeagueException, CSVException{
    	try(Reader reader = Files.newBufferedReader(path)){
    		List<LeagueBatting> battingList = csvBuilder.getCSVFileList(reader, LeagueBatting.class);
    		if(battingList == null || battingList.size() == 0) {
    			throw new LeagueException("No data present", LeagueException.ExceptionType.NO_LEAGUE_DATA);
    		}
    		Comparator<LeagueBatting> battingComparator = Comparator.comparing(batting -> (batting.century == 0 && batting.halfCentury == 0) ? batting.average: "0.0");
    		this.sortDesc(battingList, battingComparator);
    		String sortedBattingData = new Gson().toJson(battingList);
    		return sortedBattingData;
    	}
